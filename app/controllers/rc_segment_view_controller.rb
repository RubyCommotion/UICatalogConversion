class RcSegmentViewController < UIViewController
  ...
  def create_controls
    ...
    y_placement += TWEEN_MARGIN + LABEL_HEIGHT
    frame = CGRectMake(LEFT_MARGIN,
                       y_placement,
                       CGRectGetWidth(self.view.bounds) - (RIGHT_MARGIN * 2.0),
    ...
    segmented_control.setBackgroundImage(UIImage.imageNamed('/images/segmentedBackground.png'),
                                         forState: UIControlStateNormal,
                                         barMetrics: UIBarMetricsDefault)
    segmented_control.setDividerImage(UIImage.imageNamed('/images/divider.png'),
                                      forLeftSegmentState: UIControlStateNormal,
                                      rightSegmentState: UIControlStateNormal,
                                      barMetrics: UIBarMetricsDefault)

    text_attributes = {NSForegroundColorAttributeName => UIColor.blueColor,
                       NSFontAttributeName => UIFont.systemFontOfSize(13.0)}
    segmented_control.setTitleTextAttributes(text_attributes, forState:UIControlStateNormal)
    text_attributes = {NSForegroundColorAttributeName => UIColor.redColor,
                       NSFontAttributeName => UIFont.systemFontOfSize(13.0)}
    segmented_control.setTitleTextAttributes(text_attributes, forState:UIControlStateNormal)
